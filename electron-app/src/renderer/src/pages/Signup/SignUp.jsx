...
const SignUp = () => {
  ...
  const loginBG = '/assets/img/Login/LogginBG.jpg'
  const LoggingBG = {
          ...
          <div className="wrap-login100 p-t-30 p-b-50">
            ...
            <form className="login100-form validate-form p-b-33 p-t-5" onSubmit={handleSubmit}>
              <div className="form-inputs">
                {/* Input fields */}
                <div className="wrap-input100 validate-input" data-validate="Enter Your Name">
                  <input
                    className="input100"
                    type="text"
                    name="name"
                ...
                <div className="wrap-input100 validate-input" data-validate="Enter Grade">
                  <input
                    className="input100"
                    type="number"
                    name="grade"
                ...
                <div className="wrap-input100 validate-input" data-validate="Enter School">
                  <input
                    className="input100"
                    type="text"
                    name="school"
