...
contextBridge.exposeInMainWorld(
  ...
  Object.freeze({
    ...
    getHardwareCapabilities: () => ipcRenderer.invoke('hardware-get-capabilities'),
    listPrinters: () => ipcRenderer.invoke('hardware-list-printers'),
    getStationSettings: () => ipcRenderer.invoke('hardware-get-settings'),
    setStationSettings: (settings = {}) => ipcRenderer.invoke('hardware-set-settings', settings),
    previewReceipt: (payload = {}) => ipcRenderer.invoke('hardware-preview-receipt', payload),
    printReceipt: (payload = {}) => ipcRenderer.invoke('hardware-print-receipt', payload),
    testPrint: (payload = {}) => ipcRenderer.invoke('hardware-test-print', payload),
    openCashDrawer: (payload = {}) => ipcRenderer.invoke('hardware-open-cash-drawer', payload),
    getPrintHistory: () => ipcRenderer.invoke('hardware-get-print-history'),
